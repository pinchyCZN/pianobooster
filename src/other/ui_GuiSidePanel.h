...
public:
    ...
    void setupUi(QWidget *GuiSidePanel)
    {
        ...
        rhythmTapRadio = new QRadioButton(groupBox_2);
        rhythmTapRadio->setObjectName(QString::fromUtf8("rhythmTapRadio"));

        vboxLayout1->addWidget(rhythmTapRadio);
        ...
        label2 = new QLabel(GuiSidePanel);
        label2->setObjectName(QString::fromUtf8("label2"));

        hboxLayout2->addWidget(label2);

        rhythmTappingCombo = new QComboBox(GuiSidePanel);
        rhythmTappingCombo->setObjectName(QString::fromUtf8("rhythmTappingCombo"));

        hboxLayout2->addWidget(rhythmTappingCombo);
        ...
        hboxLayout3->addWidget(trackListWidget);
        ...
        hboxLayout3->addWidget(boostSlider);
    ...
    void retranslateUi(QWidget *GuiSidePanel)
    {
        ...
        rhythmTapRadio->setText(QApplication::translate("GuiSidePanel", "Rhythm Tap", 0, QApplication::UnicodeUTF8));
...
#endif // QT_NO_TOOLTIP
        label2->setText(QApplication::translate("GuiSidePanel", "Rhythm Tapping with:", 0, QApplication::UnicodeUTF8));
